...
st.set_page_config(page_title="LLM Personal Trainer", layout="wide")
...
st.title("🧠 LLM Personal Trainer Chatbot")
...
# User input
if prompt := st.chat_input("Ask me about your training activities..."):
